...
#)
    ...
    cv.Optional(CONF_SDM_IMPORT_ACTIVE_ENERGY                     ): sensor.sensor_schema(UNIT_KILOWATT_HOURS              , ICON_FLASH, 3),
    cv.Optional(CONF_SDM_EXPORT_ACTIVE_ENERGY                     ): sensor.sensor_schema(UNIT_KILOWATT_HOURS              , ICON_FLASH, 3),
    cv.Optional(CONF_SDM_IMPORT_REACTIVE_ENERGY                   ): sensor.sensor_schema(UNIT_KILOVOLT_AMPS_REACTIVE_HOURS, ICON_CURRENT_AC, 3),
    cv.Optional(CONF_SDM_EXPORT_REACTIVE_ENERGY                   ): sensor.sensor_schema(UNIT_KILOVOLT_AMPS_REACTIVE_HOURS, ICON_CURRENT_AC, 3),
    cv.Optional(CONF_SDM_VAH_SINCE_LAST_RESET                     ): sensor.sensor_schema(UNIT_KVAH                        , ICON_CURRENT_AC, 3),
    ...
    cv.Optional(CONF_SDM_TOTAL_ACTIVE_ENERGY                      ): sensor.sensor_schema(UNIT_KILOWATT_HOURS              , ICON_FLASH, 3),
    cv.Optional(CONF_SDM_TOTAL_REACTIVE_ENERGY                    ): sensor.sensor_schema(UNIT_KILOVOLT_AMPS_REACTIVE_HOURS, ICON_CURRENT_AC, 3),
    cv.Optional(CONF_SDM_L1_IMPORT_ACTIVE_ENERGY                  ): sensor.sensor_schema(UNIT_KILOWATT_HOURS              , ICON_FLASH, 3),
    cv.Optional(CONF_SDM_L2_IMPORT_ACTIVE_ENERGY                  ): sensor.sensor_schema(UNIT_KILOWATT_HOURS              , ICON_FLASH, 3),
    cv.Optional(CONF_SDM_L3_IMPORT_ACTIVE_ENERGY                  ): sensor.sensor_schema(UNIT_KILOWATT_HOURS              , ICON_FLASH, 3),
    cv.Optional(CONF_SDM_L1_EXPORT_ACTIVE_ENERGY                  ): sensor.sensor_schema(UNIT_KILOWATT_HOURS              , ICON_FLASH, 3),
    cv.Optional(CONF_SDM_L2_EXPORT_ACTIVE_ENERGY                  ): sensor.sensor_schema(UNIT_KILOWATT_HOURS              , ICON_FLASH, 3),
    cv.Optional(CONF_SDM_L3_EXPORT_ACTIVE_ENERGY                  ): sensor.sensor_schema(UNIT_KILOWATT_HOURS              , ICON_FLASH, 3),
    cv.Optional(CONF_SDM_L1_TOTAL_ACTIVE_ENERGY                   ): sensor.sensor_schema(UNIT_KILOWATT_HOURS              , ICON_FLASH, 3),
    cv.Optional(CONF_SDM_L2_TOTAL_ACTIVE_ENERGY                   ): sensor.sensor_schema(UNIT_KILOWATT_HOURS              , ICON_FLASH, 3),
    cv.Optional(CONF_SDM_L3_TOTAL_ACTIVE_ENERGY                   ): sensor.sensor_schema(UNIT_KILOWATT_HOURS              , ICON_FLASH, 3),
    cv.Optional(CONF_SDM_L1_IMPORT_REACTIVE_ENERGY                ): sensor.sensor_schema(UNIT_KILOVOLT_AMPS_REACTIVE_HOURS, ICON_CURRENT_AC, 3),
    cv.Optional(CONF_SDM_L2_IMPORT_REACTIVE_ENERGY                ): sensor.sensor_schema(UNIT_KILOVOLT_AMPS_REACTIVE_HOURS, ICON_CURRENT_AC, 3),
    cv.Optional(CONF_SDM_L3_IMPORT_REACTIVE_ENERGY                ): sensor.sensor_schema(UNIT_KILOVOLT_AMPS_REACTIVE_HOURS, ICON_CURRENT_AC, 3),
    cv.Optional(CONF_SDM_L1_EXPORT_REACTIVE_ENERGY                ): sensor.sensor_schema(UNIT_KILOVOLT_AMPS_REACTIVE_HOURS, ICON_CURRENT_AC, 3),
    cv.Optional(CONF_SDM_L2_EXPORT_REACTIVE_ENERGY                ): sensor.sensor_schema(UNIT_KILOVOLT_AMPS_REACTIVE_HOURS, ICON_CURRENT_AC, 3),
    cv.Optional(CONF_SDM_L3_EXPORT_REACTIVE_ENERGY                ): sensor.sensor_schema(UNIT_KILOVOLT_AMPS_REACTIVE_HOURS, ICON_CURRENT_AC, 3),
    cv.Optional(CONF_SDM_L1_TOTAL_REACTIVE_ENERGY                 ): sensor.sensor_schema(UNIT_KILOVOLT_AMPS_REACTIVE_HOURS, ICON_CURRENT_AC, 3),
    cv.Optional(CONF_SDM_L2_TOTAL_REACTIVE_ENERGY                 ): sensor.sensor_schema(UNIT_KILOVOLT_AMPS_REACTIVE_HOURS, ICON_CURRENT_AC, 3),
    cv.Optional(CONF_SDM_L3_TOTAL_REACTIVE_ENERGY                 ): sensor.sensor_schema(UNIT_KILOVOLT_AMPS_REACTIVE_HOURS, ICON_CURRENT_AC, 3),
    cv.Optional(CONF_SDM_CURRENT_RESETTABLE_TOTAL_ACTIVE_ENERGY   ): sensor.sensor_schema(UNIT_KILOWATT_HOURS              , ICON_FLASH, 3),
    cv.Optional(CONF_SDM_CURRENT_RESETTABLE_TOTAL_REACTIVE_ENERGY ): sensor.sensor_schema(UNIT_KILOVOLT_AMPS_REACTIVE_HOURS, ICON_CURRENT_AC, 3),
    cv.Optional(CONF_SDM_CURRENT_RESETTABLE_IMPORT_ENERGY         ): sensor.sensor_schema(UNIT_KILOWATT_HOURS              , ICON_FLASH, 3),
    cv.Optional(CONF_SDM_CURRENT_RESETTABLE_EXPORT_ENERGY         ): sensor.sensor_schema(UNIT_KILOWATT_HOURS              , ICON_FLASH, 3),
